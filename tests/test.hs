...
tests :: TestTree
tests = testGroup "Tests" [instantTests, durationTests, offsetTests, localTimeTests, gregorianTests, julianTests, copticTests, calendarDateTimeTests, zonedDateTimeTests, patternTests, withCalendarTests]
